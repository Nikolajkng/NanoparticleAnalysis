...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.options_widget.setGeometry(QtCore.QRect(20, 10, 261, 521))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(255)
        sizePolicy.setVerticalStretch(255)
        ...
        self.table_widget.setGeometry(QtCore.QRect(20, 550, 1281, 201))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(255)
        sizePolicy.setVerticalStretch(255)
        ...
        self.plots_tab_view.setGeometry(QtCore.QRect(800, 0, 501, 531))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(255)
        sizePolicy.setVerticalStretch(255)
        ...
        self.graphicsView.setGeometry(QtCore.QRect(290, 30, 500, 500))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(255)
        sizePolicy.setVerticalStretch(255)
        ...
        self.line.setGeometry(QtCore.QRect(20, 30, 261, 20))
        ...
        self.fullscreen_image_button.setGeometry(QtCore.QRect(80, 480, 141, 31))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.radioButton.setGeometry(QtCore.QRect(800, 530, 109, 25))
        self.radioButton.setObjectName("radioButton")
        self.input_image_metadata = QtWidgets.QLabel(self.centralwidget)
        self.input_image_metadata.setGeometry(QtCore.QRect(290, 10, 501, 19))
        ...
        self.setScaleButton.setGeometry(QtCore.QRect(80, 440, 141, 31))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.runSegmentationBtn.setGeometry(QtCore.QRect(60, 80, 181, 41))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.current_model_label = QtWidgets.QLabel(self.centralwidget)
        self.current_model_label.setGeometry(QtCore.QRect(80, 50, 181, 16))
        self.current_model_label.setObjectName("current_model_label")
        self.current_model_label_2 = QtWidgets.QLabel(self.centralwidget)
        self.current_model_label_2.setGeometry(QtCore.QRect(30, 50, 61, 16))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.current_model_label.setText(_translate("MainWindow", " None selected"))
        self.current_model_label_2.setText(_translate("MainWindow", "Model: "))
